...
#importing: Body extract all the fields from the body convert to python dicatornary going to put it in variable payLoad
...
Depends(oauth2.get_current_user)):
    ...
    # conn.commit() # inserting data to your code to actually save it to your data base.
...
Depends(oauth2.get_current_user)):
    ...
    if post.owner_id != current_user.id:
        ...
        detail="Not authorized to perfore requested action")
